  ...
  return (
    <>
      {!loading && employees !== null &&
        (
          <>
            <CoreTable createFormConf={employeeConf} apiService={employeeApi} setData={setUserAgreements} data={userAgreements} columns={columns} title={'UserAgreements'}></CoreTable>
          </>
        )
      }
    </>
